...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_AddScientist_t, stringdata) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_AddScientist_t qt_meta_stringdata_AddScientist = {
    {
QT_MOC_LITERAL(0, 0, 12),
QT_MOC_LITERAL(1, 13, 34),
QT_MOC_LITERAL(2, 48, 0)
    },
    "AddScientist\0on_AddScientist_pushButton_clicked\0"
    ""
};
...
void AddScientist::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->on_AddScientist_pushButton_clicked(); break;
        default: ;
        }
    }
    Q_UNUSED(_a);
...
const QMetaObject AddScientist::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_AddScientist.data,
      qt_meta_data_AddScientist,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_AddScientist.stringdata))
