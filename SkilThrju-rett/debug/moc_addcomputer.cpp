...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_AddComputer_t, stringdata) + ofs \
...
QT_MOC_LITERAL(2, 46, 0)
    ...
    "AddComputer\0on_AddComputer_pushButton_clicked\0"
    ""
};
...
void AddComputer::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->on_AddComputer_pushButton_clicked(); break;
        default: ;
        }
    }
    Q_UNUSED(_a);
...
const QMetaObject AddComputer::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_AddComputer.data,
      qt_meta_data_AddComputer,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_AddComputer.stringdata))
